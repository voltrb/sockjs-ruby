...
describe AlterEgo do
  ...
  shared_examples "a green light" do
  ...
  shared_examples "a yellow light" do
  ...
  shared_examples "a red light" do
  ...
  shared_examples "a green light with color" do
    it_should_behave_like "a green light"
  ...
  shared_examples "a yellow light with color" do
    it_should_behave_like "a yellow light"
  ...
  shared_examples "a red light with color" do
    it_should_behave_like "a red light"
